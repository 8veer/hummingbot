...
from hummingbot.strategy_v2.executors.pcr_executor.pcr_executor import PCRExecutor
...
class ExecutorOrchestrator:
    ...
    def create_executor(self, action: CreateExecutorAction):
        ...
        elif isinstance(executor_config, PCRExecutorConfig):
            executor = PCRExecutor(self.strategy, executor_config, self.executors_update_interval)
        else:
