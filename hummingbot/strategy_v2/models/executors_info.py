...
class ExecutorInfo(BaseModel):
    ...
    config: Union[PositionExecutorConfig, XEMMExecutorConfig, ArbitrageExecutorConfig, DCAExecutorConfig,
                  TWAPExecutorConfig, PCRExecutorConfig, ExecutorConfigBase]
    net_pnl_pct: Decimal
